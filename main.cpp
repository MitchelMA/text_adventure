...
void storySetup()
{
    ...
    scen_01->setup({{"lol", scen_02}, {"lol ja man", scen_03}, {"Optie 3", scen_02}}, {normInput, testRem, normInput});
    scen_02->setup({{"cool man", scen_03}, {"Nee man", scen_01}}, {normInput, normInput});
    ...
    // needs and gets
    scen_01->setGet({{0, "Paspoort"}, {2, "Monnie"}});
